...
export default defineConfig({
	main: {
		...
		define: {
			...
			"process.env.STUDIO_MODE": defineEnv(process.env.STUDIO_MODE, ""),
			"process.env.PORTAL_SUPABASE_URL": defineEnv(
				process.env.PORTAL_SUPABASE_URL,
			),
			"process.env.PORTAL_SUPABASE_ANON_KEY": defineEnv(
				process.env.PORTAL_SUPABASE_ANON_KEY,
			),
			"process.env.PORTAL_API_URL": defineEnv(process.env.PORTAL_API_URL),
		},
