...
export function TopBar() {
	...
	return (
		<div className="drag gap-2 h-12 w-full flex items-center justify-between bg-muted/45 backdrop-blur-xl backdrop-saturate-150 border-b border-border relative dark:bg-muted/35">
			<div
